...
<section class="features_area section_gap">
        <div class="container">
            ...
            <div class="wrap-contact100">
                ...
                {!! Form::open(array('url' => url('notificationSave'), 'files' => true, 'class'=>'contact100-form validate-form') )  !!}
