...
<div class="search_input"  id="search_input_box">
    <div class="container">
        {!! Form::open(array('url' => url('task/search'), 'files' => true, 'class'=>'d-flex justify-content-between') )  !!}
...
<section class="features_area section_gap">
        <div class="container">
            ...
            <div >
                ...
                <div class="col-12">
                    <a class="primary-btn text-uppercase"  href="{{url('task/add')}}">Add Task</a>
                </div>
                    ...
                    @if(isset($info[0]))
                        @foreach($info as $info1)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('task/edit').'?id='.$info1->id}}">Edit</a>/
                                    <a href="{{url('task/delete').'?id='.$info1->id}}">Delete</a>
                                </td>
