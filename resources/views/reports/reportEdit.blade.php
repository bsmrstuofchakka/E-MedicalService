...
<section class="features_area section_gap">
        <div class="container">
            ...
            <div class="wrap-contact100">
                ...
                {!! Form::open(array('url' => url('report/Save'), 'files' => true, 'class'=>'contact100-form validate-form') )  !!}
                ...
                <div class="wrap-input100 validate-input" >
                    ...
                    <input class="input100" type="text" name="amount"  value="@if(!empty($reportEdit)) {{$reportEdit->amount}} @endif" placeholder="Enter Amount">
                    <span class="focus-input100"></span>
                </div>
